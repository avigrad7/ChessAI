...
void King::checkIfCouldMove(std::vector<sf::Vector2f>& whitePositions, std::vector<sf::Vector2f>& blackPositions, int indexInArray, std::vector<sf::Vector2f>& allMoves, int moveToX, int moveToY)
{
	int thisX = 0;
	int thisY = 0;
	if (m_Color == WHITE)
